...
export const TableRow: FC<TableRowProps> = (props) =>
    <tr>
        ...
        <td><div className={props.activeCurrency + 'img'}/></td>
        {(props.data.type === 'incoming') ? (
                <td><div className='income'/> </td>
        ) : (
                <td><div className='outcome'/> </td>
        )}    
        <td><div  className='addressTransaction'>{props.data.address}</div></td>   
        <td ><div className='amountTransaction'>{props.data.amount}</div></td>   
        <td><div className='currencyTransaction'>{props.data.currency}</div></td>   
        ...
        {(props.data.status === 'Finished') ? (
                <td><div className='confirmedTransaction'>{props.data.status}</div></td>
        ) : (
                <td><div className='unconfirmedTransaction'>{props.data.status}</div></td>
        )}   
    </tr>
