...
export const currencyToIndex = (currency: DisplayTransactionCurrency): CarouselCurrencyIndex => {
    switch (currency) {
        case "BTC":
            return CarouselCurrencyIndex.BTC;
        case "ETH":
            return CarouselCurrencyIndex.ETH;
        case "LTC":
            return CarouselCurrencyIndex.LTC;
        case "XRP":
            return CarouselCurrencyIndex.XRP;
        case "BCH":
            return CarouselCurrencyIndex.BCH;
        case "DOGE":
            return CarouselCurrencyIndex.DOGE;
        case "XCH":
            return CarouselCurrencyIndex.XCH;
        case "MNR":
            return CarouselCurrencyIndex.MNR
        default:
            return CarouselCurrencyIndex.BTC;
    }
}
